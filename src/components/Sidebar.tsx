...
export default function Sidebar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:sticky top-0 left-0 h-screen z-50 flex flex-col bg-white/90 backdrop-blur-xl border-r border-purple-100 shadow-xl transition-all duration-300 ${
          collapsed ? 'w-20' : 'w-64'
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-purple-100">
          ...
          <button
            ...
            className="hidden lg:block p-2 rounded-lg hover:bg-purple-100 transition-colors"
          >
