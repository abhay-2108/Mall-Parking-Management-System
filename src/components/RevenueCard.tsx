...
import { TrendingUp, DollarSign, Activity, Users, ArrowUpRight, Clock, Calendar, Filter, Download } from 'lucide-react'
import { RevenueSkeleton } from './Skeleton'
...
export default function RevenueCard({ revenue, onDateRangeChange }: RevenueCardProps) {
  ...
  if (!revenue) return <RevenueSkeleton />
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition-all"
          >
      ...
      {showDatePicker && (
        <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border border-purple-200">
          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <button
              onClick={handleReset}
              className="px-4 py-2 text-gray-700 bg-gray-200 rounded-xl hover:bg-gray-300 transition-all"
            >
              Reset
            </button>
          </div>
